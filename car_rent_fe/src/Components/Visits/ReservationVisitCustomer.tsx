...
import {getUserPhoneNumber} from "../../keycloak";
...
const ReservationVisitCustomer = () => {
    ...
    const addReservation = async (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        const appointmentnew = {
            ...
            customerId: clientAppointments1?.id,
...
export default ReservationVisitCustomer;